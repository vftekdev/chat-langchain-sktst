    ...
    >
      <div className="flex w-full">
        <ComposerPrimitive.Input
          ...
          rows={1}
          maxLength={480}
          className="placeholder:text-[#8D8D8D] font-helveticaneuelight text-black max-h-40 flex-1 resize-none border-none bg-transparent px-4 py-2 text-sm md:text-xl outline-none focus:ring-0 disabled:cursor-not-allowed"
        />
