  ...
  return (
    <ComposerPrimitive.Root
      className={cn(
        ...
        "focus-within:border-aui-ring/20 flex w-full items-center md:justify-left justify-center rounded-2xl px-2 py-2 shadow-lg transition-all duration-300 ease-in-out border-[#A5A5A5] bg-[#F7F9FB]",
