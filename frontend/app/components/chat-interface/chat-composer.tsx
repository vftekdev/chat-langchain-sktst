  ...
  return (
    <ComposerPrimitive.Root
      className={cn(
        ...
        "focus-within:border-aui-ring/20 flex w-full items-center md:justify-left justify-center rounded-2xl border px-2 py-2 shadow-sm transition-all duration-300 ease-in-out border-[#A5A5A5] bg-[#F7F9FB]",
    ...
    >
      <ComposerPrimitive.Input
        ...
        rows={1}
        className="placeholder:text-[#8D8D8D] font-light text-[#8D8D8D] max-h-40 flex-1 resize-none border-none bg-transparent px-4 py-3 text-sm md:text-xl outline-none focus:ring-0 disabled:cursor-not-allowed"
      />
